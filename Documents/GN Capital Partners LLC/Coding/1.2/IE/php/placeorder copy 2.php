<?php
	...
	$exp_date = $_POST['expdate']['month']."/".$_POST['expdate']['year'];
...
xmlns:w="http://schemas.microsoft.com/office/word/2003/wordml"
   ...
   xml:space="preserve">
			...
			//$attachment = pack("v", base64_encode($message_for_restaurant));
			...
			*/
			...
			/*
			$faxData = array();
			$faxData['Username'] = urlencode('18666048452');
			$faxData['Password'] = urlencode('g0ttaN0m');
			$faxData['Recipient'] = urlencode('1'.$rest_row['fax'].'|Restaurant');
