...
if($loc_id && $rest_id)
{
	$query_get_updated = "SELECT MAX(updated) AS updated FROM Menu_Category WHERE (loc_id='$loc_id' AND rest_id='$rest_id')";
	...
	$query_get_highcat = "SELECT MAX(cat_id) AS highcat FROM Menu_Category WHERE (loc_id='$loc_id' AND rest_id='$rest_id' AND updated='$updated')";
	...
	$query_get_highsubcat = "SELECT MAX(subcat_id) AS highsubcat FROM Menu_Subcategory WHERE (loc_id='$loc_id' AND rest_id='$rest_id' AND updated='$updated')";
	...
	$query_get_highitem = "SELECT MAX(item_id) AS highitem FROM Menu_Item WHERE (loc_id='$loc_id' AND rest_id='$rest_id' AND updated='$updated')";
	...
	$query_get_category = "SELECT * FROM Menu_Category WHERE (loc_id='$loc_id' AND rest_id='$rest_id' AND updated='$updated') ORDER BY cat_order";
	...
	{ // A match was made.
		...
		while($cat_row = mysqli_fetch_array($result_get_category, MYSQLI_ASSOC))
		{
			...
			$query_get_subcat = "SELECT * FROM Menu_Subcategory WHERE (loc_id='$loc_id' AND rest_id='$rest_id' AND cat_id='$cat_id' AND updated='$updated') ORDER BY subcat_order";
			...
			if (@mysqli_num_rows($result_get_subcat) > 0)
			{
				...
				while($subcat_row = mysqli_fetch_array($result_get_subcat, MYSQLI_ASSOC))
				{
					...
					$query_get_item = "SELECT * FROM Menu_Item WHERE (loc_id='$loc_id' AND rest_id='$rest_id' AND subcat_id='$subcat_id' AND updated='$updated') ORDER BY item_order";
