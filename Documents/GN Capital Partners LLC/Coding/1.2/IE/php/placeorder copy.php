...
xmlns:w="http://schemas.microsoft.com/office/word/2003/wordml"
   ...
   xml:space="preserve">
			...
			//file_put_contents('https://gottanom.com/orders/'.$filename, $message_for_restaurant);
			...
			*/
			...
			$faxData = array();
			$faxData['Username'] = '8666048452';
			$faxData['Password'] = 'g0ttaN0m';
			$faxData['Recipient'] = $rest_row['fax'].'|'.$rest_row['name'];
			$faxData['Attachment'] = 'https://gottanom.com/orders/'.$filename;
			...
			if ($mail_for_customer && $mail_for_restaurant) {
