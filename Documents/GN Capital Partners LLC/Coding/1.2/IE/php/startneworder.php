...
if($loc_id && $rest_id && $item_id)
{
	...
	if($input=$_POST['input'])
	{
		...
		{
			$delivery = $postdata['newdelivery'];
			$email = $postdata['newemail'];
			$phone = $postdata['newphonenumber'];
			$first_name = $postdata['newfirstname'];
			$last_name = $postdata['newlastname'];
			$del_address = $postdata['newaddress'];
			$del_city = $postdata['newcity'];
			$del_state = $postdata['newstate'];
			$del_zip = $postdata['newzipcode'];
			if($postdata['on_beach'])
			{
