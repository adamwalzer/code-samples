...
if($loc_id && $rest_id)
{
	...
	$outputtext .= "
	<center>
	<form id='edit_order_form' onSubmit='editOrder(this);return false;' method='post' class='updateinfo_form'>
		<br>
	...
	$outputtext .= "
		...
		<th colspan='2' class='center'><input type='email' id='email' name='email' onkeyup='testEmail(this)' placeholder='Email Address' value='".$order_row['email']."' size='30' /></th>
		</tr>
		
		<tr>
		<th colspan='2' class='test' id='phone_number_test'>Phone Number</th>
		<th colspan='2' class='center'><input type='tel' id='phone_number' name='phone_number' onkeyup='testPhoneNumber(this)' placeholder='xxx-xxx-xxxx' value='".$order_row['phone']."' size='30' /></th>
		</tr>
		
		<tr>
		<th colspan='2' class='test' id='first_name_test'>First Name</th>
		<th colspan='2' class='center'><input type='text' id='first_name' name='first_name' onkeyup='testFirstName(this)' placeholder='First Name' value='".$order_row['first_name']."' size='30' /></th>
		</tr>
		
		<tr>
		<th colspan='2' class='test' id='last_name_test'>Last Name</th>
		<th colspan='2' class='center'><input type='text' id='last_name' name='last_name' onkeyup='testLastName(this)' placeholder='Last Name' value='".$order_row['last_name']."' size='30' /></th>
		</tr>
		...
		<th colspan='2' class='center'><input type='text' id='address' name='address' onkeyup='testAddress(this)' placeholder='Street Address' value='".$order_row['del_address']."' size='30' /></th>
		</tr>
		
		<tr>
		<th colspan='2' class='test' id='city_test'>City</th>
		<th colspan='2' class='center'><input type='text' id='city' name='city' onkeyup='testCity(this)' placeholder='City' value='".$order_row['del_city']."' size='30' /></th>
		</tr>
	...
	$outputtext .= "
		...
		<th colspan='2' class='center'><input type='text' id='zip' name='zip' onkeyup='testZip(this)' placeholder='Zip Code' value='".$order_row['del_zip']."' size='30' /></th>
		</tr>
		...
		<th colspan='2' id='registerbutton_test' class='center'><input type='submit' id='registerbutton' value='Edit Order' title='Edit Order' /></th>
		<th colspan='1' class='center'>&nbsp;</th>
		</tr>
