...
{ // A match was made.
	   ...
	   $(function() {
		...
		$("#must_deliver").click(function()
		{
			...
			$.post("../php/setvariable.php", postdata, function(responseTxt)
			{
				...
				$("#topbar").load("./php/categoriespage.php #top");
			});
		});
  ...
  ';
   ...
   $outputtext .= "<center><a href='".'javascript:setMain("categoriespage.php?loc_id='.$loc_id.'")'."'><h2>Categories</h2></a></center>\n";
   $outputtext .= "<center><input type='checkbox' id='must_be_open' ";
   ...
   $outputtext .= $_SESSION['current_address']."<br>".$_SESSION['current_city'].", ".$_SESSION['current_state']." ".$_SESSION['current_zip']."</a><br><br></center>\n";
