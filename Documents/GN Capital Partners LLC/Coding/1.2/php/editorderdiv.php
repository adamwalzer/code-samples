...
if($loc_id && $rest_id)
{
	...
	<center>
	<form id='edit_order_form' onSubmit='submitForm(this,".'"editorder"'.");return false;' method='post' class='updateinfo_form'>
		<br/>
	...
	$outputtext .= "
		...
		<tr>
		<th colspan='1' id='registerbutton_test' class='center'><input type='button' id='registerbutton' onClick='executePage(".'"leftorderdiv"'.")' value='Cancel' title='Cancel' /></th>
