...
{ // A match was made.
	...
	while($order_row = mysqli_fetch_array($result_get_order, MYSQLI_ASSOC))
	{
		...
		{
			$outputtext .= "
				<a href='javascript:executePage(".'"editorderdiv"'.")' class='orderinfo'>
		...
		{
			$outputtext .= "
				<a href='javascript:executePage(".'"editorderdiv"'.")' class='orderinfo'>Pickup Order Summary</a>
				";
		}
		...
		$outputtext .= "
			<br/>
			<a href='javascript:executePage(".'"revieworderdiv"'.");'>view full order</a>
			<br/>
			<br/>
			<table>
			";
		...
		while($item_row = mysqli_fetch_array($result_get_item, MYSQLI_ASSOC))
		{
			...
			{
				$outputtext .= "
					<a style='font-size:12px' href='javascript:executePage(".'"revieworderdiv"'.")'>
					";
			...
			$outputtext .= "<br/>";
			$outputtext .= "<a href='javascript:executePage(".'"editorderitempopup&order_item_id='.$item_row['order_item_id'].'"'.")'>edit</a> &nbsp;";
			$outputtext .= "<a href='javascript:executePage(".'"deleteitem&order_item_id='.$item_row['order_item_id'].'"'.")'>delete</a>";
			$outputtext .= "<br/>";
			$outputtext .= "<br/>";
		...
		$outputtext .= "
				<br/>
				<a href='javascript:executePage(".'"editordertipdiv"'.")' class='orderinfo'>tip: $".$order_row['tip']."</a>
				<br/>
				total: $".$order_row['total']."
				<br/>
				<br/>
				<input type='button' id='stylebutton' onClick='executePage(".'"revieworderdiv"'.");' name='Review Order' value='Review Order' />
				<br/>
				<a href='javascript:executePage(".'"deleteorderpopup"'.")'>delete order</a>
				<br/>
				<br/>
				<a href='javascript:executePage(".'"viewotherrestaurantspopup"'.")'>view other restaurants</a>
				<br/>
				<br/>
			</div>
			";
