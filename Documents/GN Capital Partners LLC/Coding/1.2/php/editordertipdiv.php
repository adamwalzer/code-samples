...
<center>
<form onSubmit='submitForm(this,".'"editordertip"'.");return false;' method='post' class='updateinfo_form'>
	<br/>
...
$outputtext .= "
	...
	<tr>
	<th colspan='2' class='center'><input type='button' id='registerbutton' onclick='executePage(".'"leftorderdiv"'.");' value='Cancel' title='Cancel' /></th>
