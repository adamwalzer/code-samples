<?php
	...
	$outputtext .= "
		<div id='main'>
			<center>	
				<form onSubmit='submitForm(this,".'"updateinfo"'.");return false' method='post' class='updateinfo_form' autocomplete='off'>
					...
					<tr>
					<th colspan='2' class='optional' id='username_test'><input type='text' id='username' name='username' onkeyup='testUsername(this,{".'"required"'.":false})' placeholder='";
	...
	$outputtext .= "	</select>
					...
					<tr>
					<th colspan='2' class='optional' id='address_test'><input type='text' id='address' name='address' onkeyup='testAddress(this,{".'"required"'.":false})' placeholder=".'"';
	...
	$outputtext .= '"'." size='30' /></th>
					...
					<tr>
					<th colspan='2' class='optional' id='city_test'><input type='text' id='city' name='city' onkeyup='testCity(this,{".'"required"'.":false})' placeholder='";
	...
	$outputtext .= "<select type='text' id='state' name='state' onchange='testState(this,{".'"required"'.":false})' >";
	...
	$outputtext .= "
					...
					<tr>
					<th colspan='2' class='optional' id='zip_code_test'><input type='text' id='zip_code' name='zip_code' onkeyup='testZipCode(this,{".'"required"'.":false})' placeholder='";
	...
	while($charity_row = mysqli_fetch_array($result_get_charity, MYSQLI_ASSOC))
	{
		$outputtext .= "
				<tr>
				<th colspan='2' class='left'><label><input type='checkbox' id='charity' value='".$charity_row['charity_id']."' name='".$charity_row['charity_id']."' size='30' ";
		...
		$outputtext .= "/>".$charity_row['charity_name']."</label></th>
				</tr>
			";
	}
