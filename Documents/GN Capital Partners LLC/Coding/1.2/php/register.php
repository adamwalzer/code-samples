    ...
    { // If everything's OK...
		...
		$query_insert_user = "
			INSERT INTO Customer 
					(username, password, salt, email, first_name, last_name, phone, date, activation) 
			VALUES ( '$newusername', '$hash', '$salt', '$newemail', '$newfirstname', '$newlastname', '$newphonenumber', '$date', '$activation')
			";
